...
If you attempted running the run_container_AcuRCL.sh script example, you should
find an acurcl_linux.out file in the SharedContainerDirectory directory.

If you run the run_container_AcuToWeb.sh example, you will find an additional
