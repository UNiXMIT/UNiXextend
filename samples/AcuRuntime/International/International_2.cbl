      ...
      *====================
      * 2016 - Italy - Modified By C.Contardi    
      * Added Chinese option
      *
      * National Language Support (NLS) API Reference
      * https://msdn.microsoft.com/en-us/goglobal/bb896001.aspx
      * https://msdn.microsoft.com/en-us/library/windows/desktop/dd319078(v=vs.85).aspx
      *
      *====================
       ENVIRONMENT DIVISION.
       SELECT      OPTIONAL         TEXT-FILE
                   ASSIGN TO DISK   "MyFile_2.txt".
       DATA DIVISION.
	   ...
	   DESTROY ListLanguages.
           ...
           EVALUATE                 RESULT
                   ...
                   WHEN		    7 | China
                                    SET     WFCHARSET-WIN-GB2312 TO
                                            TRUE
                                    STRING  "00000936" LOW-VALUES
                                            DELIMITED BY SIZE
                                            INTO WS-KBD-NAME
                                    MOVE    x"936" TO AnsiCP
                                    MOVE "SimSun"          
                                            TO WFONT-NAME
...
***********set environment "CODE_CASE" to 0
