      ...
      * Crt-Status
       ...
       77  key-status is special-names crt status pic 9(4) value 0.
         ...
         88  inquire-pressed                 value 91.
         88  set-wrap-text-pressed           value 92.
         88  remove-wrap-text-pressed        value 93.
      ...
      *
CCCCCC 01 wrap-text-record occurs max-rows times   pic 9.
      *
       screen section.
...
CCCCCC*
         05 Label, 
               ...
               TITLE "Working on the TITLE column:".  

         05 push-button,
               line 22, col 86,
               size 20 cells
               title "INQUIRE WRAP-TEXT",
               self-act,
               exception-value    = 91.
...
CCCCCC       when inquire-pressed  
CCCCCC         perform inquire-wrap-text
CCCCCC       when set-wrap-text-pressed 
CCCCCC         perform set-wrap-text
CCCCCC       when remove-wrap-text-pressed 
CCCCCC         perform remove-wrap-text
           end-evaluate.
      ...
      *
CCCCCC inquire-wrap-text.
           perform varying ctr from 1 by 1 until ctr > max-rows
             modify  grid-1, x = 5, y = ctr
             inquire grid-1, wrap-text in wrap-text-record(ctr)
           end-perform.         
           
           display message box "WRAP-TEXT"                      x"0d0a"
                               "Headers: " wrap-text-record(1)  x"0d0a"
                               "line 01: " wrap-text-record(2)  x"0d0a"
                               "line 02: " wrap-text-record(3)  x"0d0a"
                               "line 03: " wrap-text-record(4)  x"0d0a"
                               "line 04: " wrap-text-record(5)  x"0d0a"
                               "line 05: " wrap-text-record(6)  x"0d0a"
                               "line 06: " wrap-text-record(7)  x"0d0a"
                               "line 07: " wrap-text-record(8)  x"0d0a"
                               "line 08: " wrap-text-record(9)  x"0d0a"
                               "line 09: " wrap-text-record(10) x"0d0a"
                               "line 10: " wrap-text-record(11) x"0d0a"
                               "line 11: " wrap-text-record(12) x"0d0a"
                               "line 12: " wrap-text-record(13) x"0d0a"
                               "line 13: " wrap-text-record(14) x"0d0a"
                               "line 14: " wrap-text-record(15) x"0d0a"
                               "line 15: " wrap-text-record(16) x"0d0a"
                               "line 16: " wrap-text-record(17) x"0d0a"
                               "line 17: " wrap-text-record(18)
           .
                               
       set-wrap-text.
           perform varying ctr from 1 by 1 until ctr > max-rows
             modify grid-1, x = 5, y = ctr, wrap-text = 1
           end-perform    
           .
                               
       remove-wrap-text.
           perform varying ctr from 1 by 1 until ctr > max-rows
             modify grid-1, x = 5, y = ctr, wrap-text = 0
           end-perform              
CCCCCC     .
