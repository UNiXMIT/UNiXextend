...
CCCCCC   88  top-pressed                     value 91.
CCCCCC   88  centered-pressed                value 92.
CCCCCC   88  bottom-pressed                  value 93.
...
CCCCCC*
         05 Label, 
               ...
               TITLE "Working on CATEGORY 01:".   

         05 push-button,
               line 22, col 84,
               size 24 cells
               title "Top VALIGNMENT",
               self-act,
               exception-value    = 91.
...
CCCCCC       when top-pressed
CCCCCC         perform apply-top-valignment
CCCCCC       when centered-pressed
CCCCCC         perform apply-centered-valignment
CCCCCC       when bottom-pressed
CCCCCC         perform apply-bottom-valignment
           end-evaluate.
      ...
      *
CCCCCC*
       apply-top-valignment.
           modify grid-1, x = 2, y = 2,
                          valignment = "T"       
           .
       apply-centered-valignment.
           modify grid-1, x = 2, y = 2,
                          valignment = "C" 
           .
       apply-bottom-valignment.
           modify grid-1, x = 2, y = 2,
                          valignment = "B" 
           .
CCCCCC*     
