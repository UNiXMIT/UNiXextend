...
CCCCCC 77 ws-is-CentRowHead                  PIC  9      value 1.
CCCCCC 77 ws-registry-key                    PIC  X(100) value 
CCCCCC       "Micro Focus\extend 10.5.0\gridCtlNew-Storing-CENTERED-ROW-
CCCCCC-          "HEADINGS".  
      ...
      * Crt-Status
       ...
       77  key-status is special-names crt status pic 9(4) value 0.
         ...
         88  centered-rh-pressed             value 91.
...
CCCCCC       when centered-rh-pressed
CCCCCC         perform modify-centered-row-headings               
           end-evaluate.
      ...
      *
CCCCCC*
       modify-centered-row-headings.
      *     inquire grid-1, CENTERED-ROW-HEADINGS in ws-is-CentRowHead
           if ws-is-CentRowHead = 1   
              move 0 to ws-is-CentRowHead                  
              modify grid-1, not CENTERED-ROW-HEADINGS 
           else               
              move 1 to ws-is-CentRowHead                          
              modify grid-1, CENTERED-ROW-HEADINGS     
           end-if  
           .
CCCCCC*
      *
