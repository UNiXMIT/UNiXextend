      ...
      * Copyright (C) 1996,1998-2001,2013 Micro Focus. All rights reserved.
      *
      ...
      * Crt-Status
       ...
       77  key-status is special-names crt status pic 9(4) value 0.
         ...
         88  inquire-pressed                 value 16.
         88  sort-pressed                    value 17.
      ...
      * Grid Data
      ...
      -    "6".
         05 filler                           pic x(120)
           value "  Fiction         Miller   Henry          Tropic of Ca
      ...
      -    "5".
         05 filler                           pic x(120)
           value "  History         Stone    Irving         The Agony an
      ...
      *
       ...
       01 main-screen exception procedure exception-handler.
         03 grid-1, grid,
               ...
               sort-types         = ("9","X","X","X","X","X","D^")
               halignment         = ("L","L","L","L","L","C","R")
               row-dividers       = (1,3)
      ...
      *        centered-headings
         ...
         05 about-pb, push-button,
               ...
               self-act,
               exception-value    = 15.
         05 sort-pb, push-button,
               line 23, col 25,
               size 24 cells
               title "Inquire SORT-COLUMN",
               self-act
               exception-value    = 16.
         05 sort-pb, push-button,
               line 23, col 49,
      ...
      * in its own THREAD.
       ...
       exception-handler.
           evaluate true
             ...
             when inquire-pressed
               inquire grid-1 sort-column in grid-sort-col
               display message box "Grid is sorted by column n. " 
                                   grid-sort-col 
                                   x"0d0a"
                                   "(Negative value is for descending)"
             when sort-pressed    
               inquire grid-1 sort-column in grid-sort-col
               if grid-sort-col < 0         
