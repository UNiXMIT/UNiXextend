      *{Bench}prg-comment
      * Program1.cbl
      * Program1.cbl is generated from C:\tmp\Project-copy\Program1.Psf
      *{Bench}end
       IDENTIFICATION              DIVISION.
      *{Bench}prgid
       PROGRAM-ID. Program1.
       AUTHOR. CContardi.
       DATE-WRITTEN. venerdì 27 luglio 2012 15:58:46.
       REMARKS. 
      *{Bench}end
...
cccccc copy "Varianti.cpy" REPLACING LEADING "VA" BY "TAB"
              ==abc== BY ==program-id==. 
      ...
      *{Bench}copy-screen
       01 Screen1.
           03 Screen1-Pb-1, Push-Button, 
              COL 17,70, LINE 12,40, LINES 3,70 CELLS, SIZE 7,70 CELLS, 
              EXCEPTION-VALUE 55, ID IS 1, 
              TITLE "Push Button".
