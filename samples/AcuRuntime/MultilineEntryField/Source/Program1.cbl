      *{Bench}prg-comment
      * Program1.cbl
      * Program1.cbl is generated from C:\temp\EntryField\Program1.Psf
      *{Bench}end
       IDENTIFICATION              DIVISION.
      *{Bench}prgid
       PROGRAM-ID. Program1.
       AUTHOR. support.
       DATE-WRITTEN. 21 December 2021 08:43:48.
       REMARKS. 
      *{Bench}end
      ...
      * user-defined variable
       ...
       01 .
           03 Screen1-Ef-2-Value-Item.
               ...
               05      PIC  X(20)
                          VALUE IS " ".
           03 Screen1-Ef-2-Value REDEFINES Screen1-Ef-2-Value-Item  PIC 
            X(20)
                      OCCURS 60 TIMES.
       01 WS-COUNT         PIC  9(3)
                  VALUE IS ZEROS.
      ...
      *{Bench}copy-screen
       01 Screen1.
           03 Screen1-Ef-2, Entry-Field, 
              COL 7.00, LINE 3.40, LINES 25.40 CELLS, SIZE 21.00 CELLS, 
              3-D, ID IS 3, MAX-LINES 60, MAX-TEXT 6000, MULTILINE, 
              USE-RETURN, VALUE MULTIPLE Screen1-Ef-2-Value.
           03 Screen1-Pb-1, Push-Button, 
              COL 12.90, LINE 31.10, LINES 4.00 CELLS, SIZE 9.00 CELLS, 
              ID IS 4, 
              TITLE "TEST", 
      ...
      * display screen
              DISPLAY Standard GRAPHICAL WINDOW
                 LINES 36.00, SIZE 33.00, CELL HEIGHT 10, 
      ...
      *
       Screen1-Pb-1-Ev-Cmd-Clicked.
           ...
           PERFORM UNTIL 1 = 2
               ADD 1 TO WS-COUNT
               IF Screen1-Ef-2-Value (WS-COUNT) = SPACES
                   SUBTRACT 1 FROM WS-COUNT
                   DISPLAY MESSAGE WS-COUNT " LINE(S) OF TEXT"
                   EXIT PARAGRAPH
               END-IF
           END-PERFORM
           .
