      ...
      *** RUNTIME OPTIONS
      ** WINDOWS
      * -y rmnet.dll HTTPGET.acu
      ** LINUX
      * -y librmnet64.so HTTPGET.acu
       ...
       01  GET-ADDRESS PIC X(200) VALUE "https://reqres.in/api/users/2".
       78  NEWLINE                     VALUE H"0A".
       
       01 EXTRA-HEADERS.
           05 filler PIC X(13) value 'Authorization'.
           05 filler PIC X value x"00".
           05 filler PIC X(150) value 'Bearer ksdfjkfdjsfkdslmcdsmcklm'.
           05 filler PIC X value x"00".
           05 filler PIC X value x"00".
