      ...
      ** HTTPS certificate validation level
       15  MQSCO-HTTPSCERTVALIDATION PIC S9(9) BINARY.
      ** HTTPS certificate revocation level
       15  MQSCO-HTTPSCERTREVOCATION PIC S9(9) BINARY.
      ** Address of HTTPS Keystore
       15  MQSCO-HTTPSKEYSTOREPTR POINTER.
      ** Offset of HTTPS Keystore
       15  MQSCO-HTTPSKEYSTOREOFFSET PIC S9(9) BINARY.
      ** Length of HTTPS keystore
       15  MQSCO-HTTPSKEYSTORELENGTH PIC S9(9) BINARY.
      ** Ver:7 **
