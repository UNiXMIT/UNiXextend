      ...
      ** Ver:6 **
      ** Application name
       15  MQCNO-APPLNAME PIC X(28) VALUE SPACES.
      ** Reserved
       15  MQCNO-RESERVED2 PIC X(4) VALUE LOW-VALUES.
      ** Ver:7 **
      ** Balance Parameter Pointer
       15  MQCNO-BALANCEPARMSPTR POINTER VALUE NULL.
      ** Balance Parameter Offset
       15  MQCNO-BALANCEPARMSOFFSET PIC S9(9) BINARY VALUE 0.
      ** Reserved
       15  MQCNO-RESERVED3 PIC X(4) VALUE LOW-VALUES.
      ** Ver:8 **
