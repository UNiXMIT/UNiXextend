      ...
      **  FILE NAME:      CMQBMHOV                                    **
      **                                                              **
      **  DESCRIPTION:    MQBMHO Structure -- Buffer To Message       **
      **                  Handle Options                              **
      **                                                              **
      ******************************************************************
      **  <copyright                                                  **
      ...
      ******************************************************************
      **                                                              **
      **  FUNCTION:       This file declares the structure MQBMHO,    **
      ...
      ** Structure identifier
       15  MQBMHO-STRUCID PIC X(4) VALUE 'BMHO'.
      ** Structure version number
       15  MQBMHO-VERSION PIC S9(9) BINARY VALUE 1.
      ** Options that control the action of MQBUFMH
       15  MQBMHO-OPTIONS PIC S9(9) BINARY VALUE 1.
