      ...
      *
       ...
       01 main-screen exception procedure exception-handler.
         03 NormalDefault-Frame, Frame, 
           COL 1.5, LINE 1, LINES 32 , SIZE 128 , 
            PERMANENT,ID IS 9,,                                         ,  
           TITLE "Demo", TITLE-POSITION 1, BACKGROUND-LOW, 
           visible=0,
           ATW-CSS-ID "Frame_Demo_gridctl".
         03 grid-1, grid,
               line 2.5, col 2,
               size 125, lines 18,
         ...
         05 push-button,
               ...
               title "&Frame",
               self-act, 
               ATW-CSS-ID "button_Demo_gridctl",                
               exception-value    = 20.
      *
      ...
      * in its own THREAD.
       ...
       exception-handler.
           evaluate true
             ...
             when frame-pressed
                   continue
      *         display message box "frame-pressed"
           end-evaluate.
