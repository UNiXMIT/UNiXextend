      ...
      *{Bench}copy-screen
       01 Screen1.
           03 Screen1-Pb-1, Push-Button, 
              ...
              ID IS 1, 
              TITLE "Open 10.4.0 Release Notes", ATW-CSS-ID "OPEN-JS", 
           ...
           03 Screen1-Pb-1a, Push-Button, 
              ...
              ID IS 2, 
              TITLE "Open 10.4.0 Documentation", ATW-CSS-ID "OPEN-JS", 
              EVENT PROCEDURE Screen1-Pb-1-Event-Proc, 
              EXCEPTION PROCEDURE Screen1-Pb-1-Exception-Proc.
      ...
      * display screen
              DISPLAY Standard GRAPHICAL WINDOW
                 ...
                 WITH SYSTEM MENU, 
                 TITLE "AcuCOBOL-GT extend 10.4.0", TITLE-BAR, NO WRAP, 
      ...
      *
       Screen1-Pb-1-Ex-Cmd-Clicked.
           MODIFY Screen1-As-1 evaluate("window.open('https://bit.ly/3eU
      -                                "sFTR','_blank')")
           .
      *
       Screen1-Pb-1a-Ex-Cmd-Clicked.
           MODIFY Screen1-As-1a evaluate("window.open('https://bit.ly/ac
      -                                 "u1040','_blank')")
           .
