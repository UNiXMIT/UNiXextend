...
Additional values for A_JAVA_TRACE_VALUE can be found in the documentation - https://docs.rocketsoftware.com/search?labelkey=prod_acucobol_gt&q=A_JAVA_TRACE_VALUE  