...
To recover from this error, make sure all users are logged out of the system and recover from the transaction log to make sure the files are consistent. Then start logging from that point. - https://docs.rocketsoftware.com/search?labelkey=prod_acucobol_gt&q=C_RECOVER