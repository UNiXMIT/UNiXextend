...
SET ORACLE64=
SET MQ=
SET MQSERVER=DEV.APP.SVRCONN/TCP/127.0.0.1(1414)
...
SET VORTEX_HOME=%INSTALLDIR32%AcuGT
SET CBLMODE=32
ECHO.
...
SET VORTEX_HOME=%INSTALLDIR64%AcuGT
SET CBLMODE=64
ECHO.
ccbl32 -vv | powershell -Command "$input | Select-Object -First 1"
GOTO :SETEXTRAS
...
IF "%ACUBIT%"=="32" (
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT" /V "DefaultVersion" /t REG_SZ /d "%EXTEND%" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT\%EXTEND%" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT\%EXTEND%" /V "INSTALLDIR" /t REG_SZ /d "%INSTALLDIR32%\" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT\%EXTEND%" /V "PathName" /t REG_SZ /d "%INSTALLDIR32%AcuGT" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT\%EXTEND%" /V "PUBLICDIR" /t REG_SZ /d "%PUBLICDIR%\" /f
)
IF "%ACUBIT%"=="64" (
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Micro Focus" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Micro Focus\ACUCOBOL-GT" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Micro Focus\ACUCOBOL-GT" /V "DefaultVersion" /t REG_SZ /d "%EXTEND%" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT\%EXTEND%" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT\%EXTEND%" /V "INSTALLDIR" /t REG_SZ /d "%INSTALLDIR64%\" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT\%EXTEND%" /V "PathName" /t REG_SZ /d "%INSTALLDIR64%AcuGT" /f
    REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT\%EXTEND%" /V "PUBLICDIR" /t REG_SZ /d "%PUBLICDIR%\" /f
)
GOTO :END 
