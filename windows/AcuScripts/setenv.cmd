...
SET PATH=C:\AcuScripts;%DEFPATH32%\AcuGT\bin%ACUPATCH%;%ACUBENCH%;C:\WINDOWS\system32
SET GENESIS_HOME=%DEFPATH32%\AcuGT
GOTO :SETEXTRAS

:64BIT
SET ACUBENCH=%DEFPATH64%\acubench\
SET PATH=C:\AcuScripts;%DEFPATH64%\AcuGT\bin%ACUPATCH%;%ACUBENCH%;%DEFPATH32%\AcuGT\bin%ACUPATCH%;C:\WINDOWS\system32
