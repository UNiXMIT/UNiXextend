...
SET PATH=C:\AcuScripts;%INSTALLDIR32%AcuGT\bin%ACUPATCH%;%ACUBENCH%;C:\WINDOWS\system32
SET GENESIS_HOME=%INSTALLDIR32%AcuGT
GOTO :SETEXTRAS

:64BIT
SET ACUBENCH=%INSTALLDIR64%acubench\
SET PATH=C:\AcuScripts;%INSTALLDIR64%AcuGT\bin%ACUPATCH%;%ACUBENCH%;%INSTALLDIR32%AcuGT\bin%ACUPATCH%;C:\WINDOWS\system32
