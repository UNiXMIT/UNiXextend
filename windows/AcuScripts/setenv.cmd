...
:: SET INSTALLDIR32="C:\Program Files (x86)\Micro Focus\extend %EXTEND%\"
:: SET INSTALLDIR64="C:\Program Files\Micro Focus\extend %EXTEND%\"
:: SET PUBLICDIR="C:\Users\Public\Documents\Micro Focus\extend %EXTEND%\"
SET ACUBIT=
SET CFLAGS=FALSE
SET ACUPATCH=
SET ACUJAVA=
...
IF '%PUBLICDIR%'=='' FOR /F "tokens=2*" %%A IN ('REG.EXE QUERY "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Micro Focus\ACUCOBOL-GT\%EXTEND%" /S /V "PUBLICDIR" 2^>NUL ^| FIND "REG_SZ"') DO SET "PUBLICDIR=%%B"
