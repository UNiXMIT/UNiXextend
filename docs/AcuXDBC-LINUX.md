...
Execute the installation media and install into the desired folder on the machine where you would like AcuXDBC to run.  
...
To load the table without the 'PUBLIC.' prefix:
