...
Choose the AcuToWeb control panel from the “All Programs” menu. On Windows 10 you will need to right click the extend Start Menu and Run as administrator.
...
You should now be able to execute your program via thin client. Under extend 10.1.0 open tools and run the 32-bit runtime system command:
